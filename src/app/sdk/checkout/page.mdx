...
These features are particularly useful when you need to restrict which payment options are displayed. For instance, if you operate an online-only business, you may want to exclude cash payment options. Furthermore, if you are focusing on a specific country, you can select payment methods that are relevant to that market. This allows you to simplify the options and enhance the relevance for your customers.
