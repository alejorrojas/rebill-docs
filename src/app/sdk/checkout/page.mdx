...
This are super handy when you needs to lock down which payment option show up! Like, if your running a online-only business, you probably dont want to deal with cash payment, right? And if your focusing on certain country, you can picks and choose payment method that actually makes sense there. Pretty cool how you can trims down the option to keeps things simple and relevant for you customers!
